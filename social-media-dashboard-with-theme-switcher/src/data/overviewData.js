const overviewData = [
    ...
    },
    {
        ...
        noOfLikes: 507,
        percentageLikes: 553,
        boxColor: "hsl(203,89%,53%)"
    },{
        social: "instagram",
        socialIcon: "/images/icon-instagram.svg",
        userSocialHandle: "@realnathanf",
        noOfFollowers: 11 + "K",
        followerType: "followers",
        ...
        boxColor: "linear-gradient(45deg,hsl(37,97%,70%),hsl(5,77%,71%),hsl(329,70%,58%))"
    },{
        social: "youtube",
        socialIcon: "/images/icon-youtube.svg",
        userSocialHandle: "Nathan F.",
        noOfFollowers: 8239,
