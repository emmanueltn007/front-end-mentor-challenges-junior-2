...
toggleButton.addEventListener("click", () => {
    ...
    basicPricePlan.textContent = isToggled ? annualBasicPrice : monthlyBasicPrice;
    professionalPricePlan.textContent = isToggled ? annualProfessionalPrice : monthlyProfessionalPrice;
    masterPricePlan.textContent = isToggled ? annualMasterPrice : monthlyMasterPrice;
});